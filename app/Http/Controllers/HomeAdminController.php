...
class HomeAdminController extends Controller
{
    public function homeAdmin()
    {
        ...
        return view('pages/homeAdmin', compact('data', 'menu', 'submenu', 'transversales', 'submenu2'));
    }
    ...
    {
        $extension = '';
        return view('pages/dashboardAdmin', compact('extension'));
    }
    ...
    public function loadView(Request $request, $id)
    {
        ...
        switch ($id) {
            case 'rd':
                $vista = 'pages/redesSociales';
                $extension = 'rd';
                break;

            case 'cu':
                $vista = 'pages/carruselUno';
                $extension = 'cu';
                break;

            case 'cd':
                $vista = 'pages/carruselDos';
                $extension = 'cd';
                break;

            case 'in':
                $vista = 'pages/indicadores';
                $extension = 'in';
                break;
    ...
    public function loadViewMenu(Request $request, $id, $menuId)
    {
        ...
        $submenu2Temp = Submenu2::all();
        $submenu2 = json_decode($submenu2Temp, true);
        return view('pages/plantillaGeneral', compact('pagina', 'menu', 'submenu', 'data', 'transversales', 'menuId', 'submenu2', 'color'));
    }
